              ...
              <el-col :span="24">
                  <el-form-item class="input" style="width: 580px;" v-if="type!='info'" label="试题名称"
                      ...
                      <el-input type="textarea" min="1" :readonly="ro.examquestionName"
                                v-model="ruleForm.examquestionName" placeholder="试题名称" clearable
              ...
              <el-col :span="24">
                  ...
                  <div v-else>
                      <el-form-item class="input" label="试题类型" prop="examquestionValue">
                          <el-input v-model="ruleForm.examquestionValue" placeholder="试题类型" readonly
                                    :style='{"borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"100%","fontSize":"14px","height":"40px"}'>
                          </el-input>
                      </el-form-item>
                  </div>
                  ...
                  <div :style='{"margin":"0 20px 0 0","display":"block"}'>
                      ...
                      <div class="options" v-for="(item,index) in options" v-bind:key="index"
                          ...
                          <el-button v-if="ruleForm.examquestionTypes==1||ruleForm.examquestionTypes==2" size="mini"
                                     @click="deleteOptions(index)" type="warning" round
              ...
              <el-col :span="24">
                  <el-form-item class="input" v-if="type!='info'" label="答案解析" prop="examquestionAnalysis">
                      <el-input style="width: 580px;" type="textarea" min="1" :readonly="ro.examquestionAnalysis"
                                v-model="ruleForm.examquestionAnalysis" placeholder="答案解析" clearable
      ...
      <el-dialog title="添加选项" :visible.sync="addOptionsDialogVisiable" width="50%">
          <el-form ref="dialogForm" :model="dialogForm" :rules="dialogRules" label-width="80px">
              ...
              <el-form-item label="内容" prop="text">
                  <el-input type="textarea" min="1" v-model="dialogForm.text" placeholder="内容" clearable
                            :style='{"borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"100%","fontSize":"14px","height":"80px"}'>
                  </el-input>
              </el-form-item>
          </el-form>
          <span slot="footer" class="dialog-footer">
              <el-button @click="addOptionsDialogVisiable = false"
                         :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#ffffff","borderRadius":"4px","background":"#4299e1","width":"auto","fontSize":"14px","height":"40px"}'>取 消</el-button>
              <el-button type="primary" @click="addOptions"
                         :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#ffffff","borderRadius":"4px","background":"#4299e1","width":"auto","fontSize":"14px","height":"40px"}'>确 定</el-button>
          </span>
      </el-dialog>
