            ...
            <el-row :style='{"margin":"0 0 20px 0"}'>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试卷表</label>
                        <el-select v-model="ruleForm.exampaperId" placeholder="请选择试卷表" @change="exampaperChange"
                                   :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                            <el-option
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考试时长(分钟)</label>
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="考试时长(分钟)" clearable  :readonly="ro.exampaperDate"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试卷总分数</label>
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="试卷总分数" clearable  :readonly="ro.exampaperMyscore"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试题表</label>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        ...
                        <el-input v-model="examquestionForm.examquestionName"
                                  placeholder="试题名称" clearable  :readonly="ro.examquestionName"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                <el-col :span="24">
                    <div :style='{"margin":"0 20px 0 0","display":"block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">选项</label>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">答案解析</label>
                        <el-input v-model="examquestionForm.examquestionAnalysis"
                                  placeholder="答案解析" clearable  :readonly="ro.examquestionAnalysis"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试题排序</label>
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="试题排序，值越大排越前面" clearable  :readonly="ro.examquestionSequence"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考生作答</label>
                        <el-input v-model="ruleForm.examredetailsMyanswer"
                                  placeholder="考生作答" clearable  :readonly="ro.examredetailsMyanswer"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
