        ...
        <div v-if="showFlag">
            <el-form :style='{"width":"95%","margin":"40px 0 20px 5%"}' :inline="true" :model="searchForm" class="center-form-pv">
                <el-row :style='{"display":"block"}'>
                    ...
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">用户</label>
                        <el-input v-model="searchForm.studentname" placeholder="用户姓名" clearable></el-input>
                    </div>
                    <el-button :style='{"border":"1px solid #3498db","cursor":"pointer","padding":"0 24px","outline":"none","color":"#3498db","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' round @click="search()">
                ...
                <el-row class="ad" :style='{"margin":"20px 0","display":"flex"}'>
                    <el-form-item>
                        <el-button
                                v-if="isAuth('examrewrongquestion','统计')"
								:style='{"border":"1px solid #2ecc71","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#2ecc71","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}'
                                @click="goStatistics()"
                        >统计</el-button>
                        <el-button
            ...
            <div class="table-content">
                ...
                >
                    ...
                    <el-table-column prop="exampaperName" header-align="center" align="center" label="试卷名称"></el-table-column>
                    ...
                    <el-table-column prop="examquestionValue" header-align="center" align="center" label="试题类型"></el-table-column>
                    <el-table-column prop="studentname" header-align="center" align="center" label="用户姓名"></el-table-column>
                    <el-table-column prop="examredetailsMyanswer" header-align="center" align="center" label="考生作答">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="insertTime" header-align="center" align="center" width="170" label="记录时间"></el-table-column>
                    <el-table-column width="300" header-align="center" align="center" label="操作">
                        <template slot-scope="scope">
                            <el-button v-if="isAuth('examrewrongquestion','查看')" 
                            ...
                            <el-button v-if="isAuth('examrewrongquestion','删除')" 
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            formattedDataList() {
                return this.dataList.map(item => {
                    return {
                        ...item,
                        exampaperName: item.exampaperName || '课后习题'
                    };
                });
            }
        },
        ...
        methods: {
            ...
            // 跳转到统计页面
            goStatistics() {
                this.$router.push({ path: '/modules/examrewrongquestion/statistics' });
            },
        }
