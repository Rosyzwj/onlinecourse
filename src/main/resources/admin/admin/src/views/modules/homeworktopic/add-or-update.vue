    ...
    <div class="addEdit-block" :style='{"padding":"20px 0 0 5%","width":"95%"}'>
        <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="auto">
            <el-row :style='{"margin":"0 0 20px 0"}'>
                <el-col :span="12" v-if="sessionTable !='homework' ">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        ...
                        <el-input v-model="homeworkForm.homeworkName" placeholder="课后习题名称" clearable readonly
                ...
                <el-col :span="12" v-if="sessionTable !='homework' ">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">课后习题总分数</label>
                        <el-input v-model="homeworkForm.homeworkMyscore" placeholder="课后习题总分数" clearable readonly
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试题分数</label>
                        <el-input v-model="ruleForm.homeworktopicNumber" placeholder="试题分数" clearable
                                  :readonly="ro.homeworktopicNumber"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$http({
                url: `homework/page?page=1&limit=100`,
                method: "get"
            }).then(({
                data
            }) => {
                if (data && data.code === 0) {
                    this.homeworkOptions = data.data.list;
                }
            });
            this.$http({
        ...
        methods: {
            ...
            homeworkChange(id) {
                this.$http({
                    url: `homework/info/` + id,
                    method: "get"
                }).then(({
                    data
                }) => {
                    if (data && data.code === 0) {
                        this.homeworkForm = data.data;
                    }
                });
            },
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.options = JSON.parse(_this.ruleForm.examquestionOptions)
                        _this.homeworkChange(data.data.homeworkId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `homeworktopic/${!this.ruleForm.id ? "save" : "examinationUpdate"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({
                            data
                            ...
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.homeworktopicCrossAddOrUpdateFlag = false;
                                        this.parent.search();
