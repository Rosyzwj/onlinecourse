            ...
            <el-row :style='{"margin":"0 0 20px 0"}'>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试卷编号</label>
                        <el-input v-model="ruleForm.examredetailsUuidNumber" placeholder="试卷编号" clearable
                                  :readonly="ro.examredetailsUuidNumber"
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">正确答案</label>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        ...
                        <el-input v-model="examquestionForm.examquestionSequence" placeholder="试题排序，值越大排越前面" clearable readonly
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        ...
                        <el-input v-model="yonghuForm.name" placeholder="学生姓名" clearable readonly
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考生答案</label>
                        <el-input v-model="ruleForm.examredetailsMyanswer" placeholder="考生答案" clearable
                                  :readonly="ro.examredetailsMyanswer"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
                        <label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试题得分</label>
                        <el-input v-model="ruleForm.examredetailsMyscore" placeholder="试题得分" clearable
                                  :readonly="ro.examredetailsMyscore"
                                  :style='{"border":"0","borderRadius":"4px","padding":"0 12px","outline":"none","color":"#000","width":"250px","fontSize":"14px","height":"40px"}'>
                        </el-input>
                    </div>
                </el-col>
