...
public class ExampaperEntity<T> implements Serializable {
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat
    @ColumnInfo(comment="考试开始时间",type="timestamp")
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat
    @ColumnInfo(comment="考试结束时间",type="timestamp")
    ...
    public String toString() {
        return "Exampaper{" +
            ...
            ", start_time=" + DateUtil.convertString(start_time,"yyyy-MM-dd") +
            ", end_time=" + DateUtil.convertString(end_time,"yyyy-MM-dd") +
