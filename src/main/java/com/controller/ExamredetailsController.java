    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(examredetails !=null){
            ...
            //级联表 学生
            //级联表
            StudentEntity yonghu = studentService.selectById(examredetails.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody ExamredetailsEntity examredetails, HttpServletRequest request){
        ...
        if(false)
            ...
            examredetails.setYonghuId(Long.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
